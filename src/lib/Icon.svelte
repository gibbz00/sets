<script lang="ts">
	...
	const paths = {
		arrowRightAlt:
			"m28.05 35.9-2.15-2.1 8.4-8.4H8v-3h26.3l-8.45-8.45 2.15-2.1L40.05 23.9Z",
		delete:
			"M13.05 42q-1.2 0-2.1-.9-.9-.9-.9-2.1V10.5H8v-3h9.4V6h13.2v1.5H40v3h-2.05V39q0 1.2-.9 2.1-.9.9-2.1.9Zm21.9-31.5h-21.9V39h21.9Zm-16.6 24.2h3V14.75h-3Zm8.3 0h3V14.75h-3Zm-13.6-24.2V39Z",
		...
		menu: "M6 40v-3h36v3H6Zm0-10v-3h36v3H6Zm0-10v-3h36v3H6Z",
	};
</script>

<svg
	class={`h-full w-7 my-auto ${cls}`}
	viewBox="0 0 48 48"
>
